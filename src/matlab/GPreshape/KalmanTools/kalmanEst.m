%% kalman estimator of position, velocity and acceleration based on position measurements
...
for i=1:length(t)
    ...
    L = P_pred*C'*H;
    [x_pred, P_pred, x_hat,P_hat]=KalmanPredict(x_pred,P_pred,x_m(i),A,C,Gv*Q*Gv',R);
...
legend('est. acc.','true acc.','location','eastoutside')
...
%%
[est_p, est_v,est_a]=EstimateVA_P(x_m,dt,Q,R,[0;0;0],[1 0 0;0 100 0;0 0 100]);
