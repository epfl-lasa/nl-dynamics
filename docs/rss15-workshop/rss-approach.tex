...
The procedure of reshaping the DS such that it locally aligns with incrementally-arriving training data is described in detail in \todo{add reference to klas's RAS paper}.
...
\todo[inline]{Describe how we learn the M matrix using a GP consisting of
